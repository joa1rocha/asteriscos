 ...
 */
function asteriscos_customize_register( $wp_customize ) {
 ...
 */
function asteriscos_sanitize_page_layout( $input ) {
	$valid = array(
		'one-column' => __( 'One Column', 'twentyseventeen' ),
		'two-column' => __( 'Two Column', 'twentyseventeen' ),
	);
 ...
 */
function asteriscos_sanitize_colorscheme( $input ) {
 ...
 * @return void
 */
function asteriscos_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function asteriscos_customize_partial_blogdescription() {
 ...
 */
function asteriscos_is_static_front_page() {
 ...
 */
function asteriscos_is_view_with_layout_option() {
 ...
 */
function asteriscos_customize_preview_js() {
