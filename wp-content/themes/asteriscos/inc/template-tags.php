 ...
 */
function asteriscos_entry_footer() {
 ...
 */
function asteriscos_front_page_section( $partial = null, $id = 0 ) {
 ...
 * @return bool
 */
function asteriscos_categorized_blog() {
 ...
 */
function asteriscos_category_transient_flusher() {
