...
.colors-custom.page:not(.asteriscos-front-page) .entry-title,
...
.colors-custom .asteriscos-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.asteriscos-front-page .panel-content .recent-posts article,
...
.colors-custom.asteriscos-front-page article:not(.has-post-thumbnail):not(:first-child),
